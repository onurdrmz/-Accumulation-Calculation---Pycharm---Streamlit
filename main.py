...
yas_Bitis = st.sidebar.number_input("Hedef Yaşınız: ", min_value=18, max_value=65)
aylik_Birikim = st.sidebar.number_input("Aylık Birikiminiz Girin: ", value=0)
daire_Fiyati = st.sidebar.number_input("Dairelerin Fiyatı: ", value=0)
...
solnot = st.sidebar.text("NOT: Enflasyon ve Faiz Dikkate Alınmayacaktır !")
...
st.title("Birikim Hesaplamaları")

if btn:
    if yas_Baslangic==0 or yas_Bitis==0 or aylik_Birikim==0 or daire_Fiyati==0 or pesinat_Yuzdesi==0 or kira_Getirisi==0:
        ...
        while yas < yas_Bitis:
            ...
            # Eğer birikim, peşinatı karşılıyorsa daire alır
